...
public class PhoneAuthActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mHeaderText = (TextView) findViewById(R.id.continueLabel);
        mVerifyText = (TextView) findViewById(R.id.verifyLabel);
    ...
    private void startPhoneNumberVerification(String phoneNumber) {
        ...
        PhoneAuthProvider.getInstance().verifyPhoneNumber(
                "+63" + phoneNumber,        // Phone number to verify
                60,                 // Timeout duration
...
//                                        }
                                        ...
                                        y.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                                        y.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK);
                                        y.putExtra("SESSION_CONTACT", contactno);
                                        y.putExtra("SESSION_USER_ID", userID);
                                        startActivity(y);
                                        finish();
